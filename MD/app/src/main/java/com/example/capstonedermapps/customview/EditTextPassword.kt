package com.example.capstonedermapps.customview
...
import com.example.capstonedermapps.R
...
class EditTextPassword: TextInputEditText, View.OnTouchListener{
    ...
    private fun init() {
        eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_mata_off) as Drawable // x button
                ...
                return when (event.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (transformationMethod.equals(HideReturnsTransformationMethod.getInstance())) {
                            ...
                            eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_mata_off) as Drawable
                            showEyeButton()
                        } else {
                            transformationMethod = HideReturnsTransformationMethod.getInstance() // show password
                            eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_mata) as Drawable
                            showEyeButton()
                        }
                        true
                    }

...
import com.example.capstonedermapps.ScanActivity.Companion.CAMERA_X_RESULT
import com.example.capstonedermapps.databinding.ActivityCameraBinding
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Helper.showToast(this@ActivityCamera,"Failed to take picture.")
                }
